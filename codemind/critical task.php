...
<body>
	<!-- <div class="container">
		<div class="form1">
		<div class="row"><center><h1><b>Registration form</b></h1></center><hr></div>
		<form name="form_name" onsubmit="return validations()" onkeypress="return valid()">
			...
			<div class="row">
    				...
    				<input type="radio"name="gender" id="genders">female<br><br>
			</div>
			<div class="row">
					<label>D.O.B:</label>
			...
			<div class="row">
					...
					&nbsp&nbsp<input type="Reset" name="clear" id="name">
					<input type="submit">
			</div>
		</form>
	</div>
